...
```bash
F:/Cow/cow_fitness_yolo/.venv/Scripts/python.exe src/train_fitness_classifier.py --data data_fitness --epochs 50 --imgsz 224 --batch 16
```
...
```bash
F:/Cow/cow_fitness_yolo/.venv/Scripts/python.exe src/infer_fitness_classifier.py "path/to/image.jpg" --model models/cow_fitness_cls.pt
```
