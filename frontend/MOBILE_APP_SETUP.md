...
- `models/trained/cow_fitness_cls.pt` for good/average/bad
- `models/trained/cattle_species_cls.pt` for cow vs buffalo vs other
- `models/trained/cow_breed_cls.pt` for cow breed classification
...
yolo export model=models/trained/cow_yolos_best.pt format=tflite
```
