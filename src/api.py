...
FITNESS_MODEL_PATH = os.getenv("FITNESS_MODEL_PATH", "models/cow_fitness_cls.pt")
SPECIES_MODEL_PATH = os.getenv("SPECIES_MODEL_PATH", "models/cattle_species_cls.pt")
BREED_MODEL_PATH = os.getenv("BREED_MODEL_PATH", "models/cow_breed_cls.pt")
app = FastAPI(title="Cow Fitness YOLO API")
model = YOLO(MODEL_PATH)

fitness_model = None
fitness_model_path = Path(FITNESS_MODEL_PATH)
if fitness_model_path.exists():
    fitness_model = YOLO(str(fitness_model_path))

species_model = None
species_model_path = Path(SPECIES_MODEL_PATH)
if species_model_path.exists():
    species_model = YOLO(str(species_model_path))

breed_model = None
breed_model_path = Path(BREED_MODEL_PATH)
